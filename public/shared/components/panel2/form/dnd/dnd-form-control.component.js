...
var DragnDropFormControl = (function () {
    ...
    DragnDropFormControl.prototype.ngOnInit = function () {
    ...
    DragnDropFormControl.prototype.onDropSuccess = function (e) {
        if (e.dragData.hasOwnProperty('preventAdd') && e.dragData.preventAdd === true) {
            return;
        }
        this.pushValue(e.dragData.option);
    };
    DragnDropFormControl.prototype.pushValue = function (value) {
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], DragnDropFormControl.prototype, "placeholder", void 0);
    __decorate([
    ...
    DragnDropFormControl = __decorate([
        core_1.Component({
            ...
            directives: [ng2_dnd_1.DND_DIRECTIVES, index_1.ChipComponent, forms_1.NgModel, angular2_material_1.MATERIAL_DIRECTIVES],
