        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('projects.update', $project->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    ...
                    <input type="text" id="title-field" name="title" class="form-control" value="{{ old("title") or $project->title }}"/>
                       @if($errors->has("title"))
                    ...
                    <textarea class="form-control" id="description-field" rows="3" name="description">{{ old("description") or $project->description }}</textarea>
                    ...
                    <input type="text" id="client_id-field" name="client_id" class="form-control" value="{{ old("client_id") or $project->client_id }}"/>
                    ...
                    <input type="text" id="image_id-field" name="image_id" class="form-control" value="{{ old("image_id") or $project->image_id }}"/>
