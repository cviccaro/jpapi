...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Images / Edit #{{$image->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('images.update', $image->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('path')) has-error @endif">
                    ...
                    <input type="text" id="path-field" name="path" class="form-control" value="{{ old("path") or $image->path }}"/>
                       @if($errors->has("path"))
                    ...
                    <input type="text" id="filename-field" name="filename" class="form-control" value="{{ old("filename") or $image->filename }}"/>
                    ...
                    <input type="text" id="alias-field" name="alias" class="form-control" value="{{ old("alias") or $image->alias }}"/>
                       @if($errors->has("alias"))
                    ...
                    <input type="text" id="mimetype-field" name="mimetype" class="form-control" value="{{ old("mimetype") or $image->mimetype }}"/>
                    ...
                    <input type="text" id="extension-field" name="extension" class="form-control" value="{{ old("extension") or $image->extension }}"/>
                    ...
                    <input type="text" id="size-field" name="size" class="form-control" value="{{ old("size") or $image->size }}"/>
                       @if($errors->has("size"))
                    ...
                    <input type="text" id="last_modified-field" name="last_modified" class="form-control" value="{{ old("last_modified") or $image->last_modified }}"/>
