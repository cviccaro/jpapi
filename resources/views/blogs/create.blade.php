        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('blogs.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    ...
                    <textarea class="form-control" id="summary-field" rows="3" name="summary">{{ old("summary") }}</textarea>
                    ...
                    <input type="text" id="author-field" name="author" class="form-control" value="{{ old("author") }}"/>
                    ...
                    <input type="text" id="division_id-field" name="division_id" class="form-control" value="{{ old("division_id") }}"/>
